...
class Presupuesto extends Conexion {
    ...
    public function listar(){
		...
		try{
			...
			$consulta="SELECT P.ID_PRESUPUESTO, P.MONTO_INICIAL,P.MONTO_ACTUAL,P.PORCENTAJE_EJECUTADO,
			 C.DESCRIPCION ,C.ID_CATEGORIA FROM presupuesto as P INNER JOIN categoria as C
    ...
    public function registrarPresupuesto($data){
        ...
        try{
			...
			if( isset($data->ID_CATEGORIA) && isset($data->MONTO_INICIAL)  && isset($data->MONTO_ACTUAL)  && isset($data->PORCENTAJE_EJECUTADO) && 
