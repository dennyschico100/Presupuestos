...
<div style="border:0px solid green;" class="container-fluid">
    ...
    <section class="col-md-12  content overflow-hidden">
        ...
        <h2>Peticiones de movimiento de fondos </h2>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-6 form-group ">
                        ...
                        <input type="text" name="idTransaccion" id="idTransaccion" class="form-control"
                            placeholder="" />
                        ...
                        <label>Id Usuario Solicitante</label>
                    ...
                    <div class="col-md-6 form-group ">
                        ...
                        <input type="text" name="idOrigen" id="idOrigen" class="form-control" placeholder="" />
                        <span class="text-danger  campo-requerido"><strong></strong></span>
                        ...
                        <input type="text" name="idDestino" id="idDestino" class="form-control" placeholder=""
                            pattern="^[a-zA-Z_áéíóúñ\s]{0,30}$" />
                        <span class="text-danger  campo-requerido"><strong></strong></span>
...
<div>
  ...
  https://cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js
    ...
    <script src="<?php echo URL_ROOT . '/public/js/listarTransacciones.js'; ?>"></script>